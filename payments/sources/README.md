...
A source's `type` represents the payment method used to create that object. You can find a full list of these `type` values on the [Sources API reference](https://www.digitalriver.com/docs/commerce-admin-api/#tag/Source) page.&#x20;
