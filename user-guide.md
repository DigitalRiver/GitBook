...
* To search for an order:
  ...
  6.  If the order is tax inclusive and promotions have been applied, you can see adjustments (as shown in the example) applied to the order line items and/or shipping. See [this section](user-guide.md#tax-inclusive-sites-promotions-and-tax-identifiers) for more details. \
      \
      When applicable, You can look at the **General** tab see the order details which display the amount of replaced promotions as an **Adjustment - Product Promotions** Additionally, the amount of the Tax Discount applied is as an **Adjustment - Product Tax**.\
      \
      ![](<.gitbook/assets/image (31).png>)\
      Finally, the **Shipping Tax Discount** is displayed as **Adjustment - Shipping Tax**.\
      \
      ![](<.gitbook/assets/image (36).png>)\
      \
      The **Total Tax Included** value should be zero when a tax identifier is applied.
...
* Select **Merchant Tools**, select **Orders**, choose an order, and click **Notes**. The following occurs
  ...
  * If the order is tax inclusive and promotions have been applied, you may see a note added to the order reflecting the original promotions applied. See [this section](user-guide.md#tax-inclusive-sites-promotions-and-tax-identifiers) for more details\
