...
* We added the ability to [add ](../../cart/creating-or-updating-a-cart/adding-required-information-for-specific-payment-methods.md#adding-an-organization-identifier-to-a-cart)or [remove ](../../cart/creating-or-updating-a-cart/adding-required-information-for-specific-payment-methods.md#removing-an-organization-identifier-from-the-cart)the organization identifier (client\_reference\_id) to a cart for the [TreviPay ](../../payments/payments-solutions/digitalriver.js/payment-methods/trevipay.md)payment method.
...
* A `chargeType` to the `subscriptionInfo` section in the request and response.  See [Providing subscription information](../../cart/creating-or-updating-a-cart/providing-subscription-information.md) for more details.
