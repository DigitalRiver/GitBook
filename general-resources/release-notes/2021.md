...
* We added the ability to [remove a tax identifier from a cart](../../shopper-apis/cart/configuring-taxes/managing-tax-identifiers.md#removing-a-tax-identifier-from-a-cart).
...
We updated the information on [landed cost](../../shopper-apis/cart/pricing/landed-costs/).
