...
We updated the examples and added information on how to create a merchant-initiated transaction (MIT) in [Providing subscription information](../../cart/creating-or-updating-a-cart/providing-subscription-information.md).
...
* Added [phonetic fields](../../cart/creating-or-updating-a-cart/providing-address-information.md#japanese-phonetics) to the billing and shipping addresses.
...
* Added [phonetic fields](../../cart/creating-or-updating-a-cart/providing-address-information.md#japanese-phonetics) to the following schemas: DefaultAddress and ExpandedAddress.
