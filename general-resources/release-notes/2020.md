...
You can now modify a subscription during a [midterm change](../../master/subscriptions/midterm-change.md). That includes [applying a midterm change with price override](../../master/subscriptions/selling-subscriptions-without-add-ons/applying-a-midterm-change-with-price-override.md), [assigning a perpetual price](../../master/subscriptions/selling-subscriptions-without-add-ons/assigning-a-perpetual-unit-price.md), or [reducing the subscription quantity](../../master/subscriptions/selling-subscriptions-without-add-ons/reducing-the-quantity-of-a-subscription.md).
...
We updated the examples and added information on how to create a merchant-initiated transaction (MIT) in [Providing subscription information](../../master/cart/removing-a-specific-applied-offer/providing-subscription-information.md).
...
* We added support for [landed costs](../../master/orders-1/landed-costs.md).
* You can now [set a price list](../../master/cart/configuring-taxes.md#setting-the-price-list-to-tax-inclusive-or-exclusive) or [shipping costs](../../master/cart/configuring-taxes.md#setting-the-shipping-cost-to-tax-inclusive-or-exclusive) to tax inclusive or exclusive.
...
You can now apply a [shipping discount](../../master/cart/providing-a-shipping-discount.md) to a customer's order
...
* We added information on migrating to [payment sessions](../../master/cart/payment-sessions.md) to [Payment integrations](broken-reference).&#x20;
...
* Added [phonetic fields](../../master/cart/removing-a-specific-applied-offer/providing-address-information.md#japanese-phonetics) to the billing and shipping addresses.
...
* Added [phonetic fields](../../master/cart/removing-a-specific-applied-offer/providing-address-information.md#japanese-phonetics) to the following schemas: DefaultAddress and ExpandedAddress.
...
* You can now capture when a customer[ accepts the Terms of Sale](../../master/cart/removing-a-specific-applied-offer/terms-of-sale-acceptance.md).
* Added [phonetic fields](../../master/cart/removing-a-specific-applied-offer/providing-address-information.md#japanese-phonetics) to [Orders ](https://www.digitalriver.com/docs/commerce-api-reference/#tag/Orders/paths/\~1v1\~1shoppers\~1me\~1orders\~1{orderId}/get)and [Order Lookup](https://www.digitalriver.com/docs/commerce-api-reference/#tag/Order-Lookup/paths/\~1v1\~1shoppers\~1order-lookup/post) resources.
