...
The Salesforce B2C LINK Cartridge package contains three cartridges with the [Drop-in functionality](https://docs.digitalriver.com/digital-river-api/payments/payment-integrations-1/drop-in) for Storefront Reference Architecture (SFRA):
