...
After initial installation, continue following the steps below to customize and configure the WordPress Plugin.
...
![](.gitbook/assets/DRSettingsLocales.png)
...
The plugin supports Global Tax management. Registered shoppers in the U.S. locale can apply their tax exemption in the checkout flow. When enabled for the storefront, a shopper (non-U.S. locale) can apply their "Tax Identifier" in the checkout flow. To display pricing as tax exclusive on checkout, click the check box.&#x20;

![](.gitbook/assets/DisplayasExcludingTax.png)
