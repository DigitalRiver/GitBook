...
We added support for the [Boleto ](../payment-integrations-1/digitalriver.js/payment-methods/boleto.md)payment methods.
...
We added the ability to [create a refund for a delayed payment method](../returns-and-refunds-1/refunds/managing-a-refund-for-a-delayed-payment-method.md) such as [Konbini](../payment-integrations-1/digitalriver.js/payment-methods/konbini.md), and [Wire Transfer](../payment-integrations-1/digitalriver.js/payment-methods/wire-transfer.md).
...
* We expanded the pay later options that are now available in the [PayPal Wallet](../payment-integrations-1/digitalriver.js/payment-methods/paypal.md#paypal-express-checkout-digital-wallet), including [PayPal RatenZahlung](../payment-integrations-1/digitalriver.js/payment-methods/paypal.md#paypal-ratenzahlung) for German shoppers.
...
We added `supportsStorage` to indicate whether a payment method supports storage to [Retrieving available payment methods](../payment-integrations-1/digitalriver.js/reference/digitalriver-object.md#retrieving-available-payment-methods).

## 2021/7/29

We expanded the pay later options that are now available in the [PayPal Wallet](../payment-integrations-1/digitalriver.js/payment-methods/paypal.md#paypal-express-checkout-digital-wallet), including [PayPal Pay in 4](../payment-integrations-1/digitalriver.js/payment-methods/paypal.md#paypal-pay-in-4) for shoppers in Australia and France, as well as [PayPal Pay in 3](../payment-integrations-1/digitalriver.js/payment-methods/paypal.md#paypal-pay-in-3) and [PayPal Credit](../payment-integrations-1/digitalriver.js/payment-methods/paypal.md#paypal-credit) for UK shoppers.

## 2021/7/27

You can now use the [Delayed Payment Instructions element](../payment-integrations-1/digitalriver.js/reference/delayed-payment-instructions-element.md) to generate a template that contains the instructions that explain how to complete payment for delayed payment types such as Konbini and Wire Transfer.
...
We added support for [Pay in 3](../payment-integrations-1/digitalriver.js/payment-methods/paypal.md#paypal-pay-in-3) to the [PayPal ](../payment-integrations-1/digitalriver.js/payment-methods/paypal.md)payment method.
...
You can now programmatically retrieve a list of your site's [authorized billing](../sites/getting-a-sites-authorized-billing-countries.md) or [shipping countries](../sites/getting-a-sites-authorized-shipping-countries.md) using your [Global Commerce user credentials](../getting-started/best-practices.md#sending-api-calls-using-auth).

## 2021/4/29

We replaced Supported geographies for each [payment method](../payment-integrations-1/digitalriver.js/payment-methods/) in [DigitalRiver.js](../payment-integrations-1/digitalriver.js/) with Supported markets. To find information on supported markets and currencies for Drop-in and DigitalRiver.js, go to:
...
* Digital River Clients now can extend a branded, fully managed line of credit program to their business buyers that is engineered to increase purchase frequency, average order values, brand loyalty, and cashflow, while mitigating risk. By offering TreviPay you cultivate a consumer-like purchase experience for buyers, so they can purchase what they need now and pay later with net terms – all online.\
  Learn how you can offer [TreviPay](../payment-integrations-1/digitalriver.js/payment-methods/trevipay.md) to your buyers!&#x20;
...
We added the `continue` type to the list of button types for [Drop-in](../payment-integrations-1/drop-in/) and made it the default type in [Customizing the text of the Drop-in button](../payment-integrations-1/drop-in/drop-in-integration-guide.md#customizing-the-text-of-the-drop-in-button).
...
* We moved the description of [API keys](../getting-started/best-practices.md#api-keys) from the Commerce API Reference to [Best practices](../getting-started/best-practices.md).

## 2021/1/15

You can now use the [`authenticateSource` method](../payment-integrations-1/digitalriver.js/reference/digitalriver-object.md#authenticating-sources) to determine whether the saved payment source selected by a customer during the checkout process requires [Strong Customer Authentication](../payment-integrations-1/psd2-and-sca/) (SCA).

## 2021/1/12

* When creating a source, you can now configure the `usage` parameter. It allows you to specify the type of transaction the source will likely be used for in the future. The parameter is available in both [Drop-in](../payment-integrations-1/drop-in/drop-in-integration-guide.md#specifying-a-sources-future-use) and [DigitalRiver.js](../payment-integrations-1/digitalriver.js/reference/digitalriver-object.md#specifying-a-sources-future-use). We recommend you use it when building [purchase](../payment-integrations-1/building-your-workflows.md#credit-card-details-saved-by-customer-during-checkout) and [account management](../payment-integrations-1/building-your-workflows.md#saving-a-credit-card-for-future-use) workflows that allow customers to save their credit card information.&#x20;
* When [creating an instance of Drop-in](../payment-integrations-1/drop-in/drop-in-integration-guide.md#step-6-allow-the-shopper-to-interact-with-hydrate), you can now [customize the text of the button](../payment-integrations-1/drop-in/drop-in-integration-guide.md#customizing-the-drop-in-button-text). Additionally, we created new [Drop-in options](../payment-integrations-1/drop-in/drop-in-integration-guide.md#drop-in-options) that allow you to set the `showTermsOfSaleDisclosure` and `disableAutomaticRedirects` parameters.
...
We added the [best practices](../getting-started/best-practices.md) for using the Commerce API that includes [Authentication](../getting-started/best-practices.md#authentication), [Creating authenticated shopper tokens](../getting-started/best-practices.md#creating-session-aware-access-tokens), [Caching responses](../getting-started/best-practices.md#caching-responses), [Capturing the customer's IP address](../getting-started/best-practices.md#capturing-the-customers-ip-address), and [Elements](../getting-started/best-practices.md#elements).&#x20;
...
We updated the [supported geographies](../payment-integrations-1/digitalriver.js/payment-methods/klarna.md#supported-geographies) for [Klarna](../payment-integrations-1/digitalriver.js/payment-methods/klarna.md) to show the minimum and maximum order amount and the payment method type.
...
We added more [custom styles](../payment-integrations-1/digitalriver.js/reference/elements.md#available-custom-styles) for [styling an element container](../payment-integrations-1/digitalriver.js/reference/elements.md#styling-an-element-container) in [DigitalRiver.js](../payment-integrations-1/digitalriver.js/).

## 2020/11/30

We added [error types](../payment-integrations-1/digitalriver.js/reference/error-types-codes-and-objects.md#error-types) to [Error types, codes, and objects](../payment-integrations-1/digitalriver.js/reference/error-types-codes-and-objects.md).

## 2020/11/19

We added support for [Pay in 4](../payment-integrations-1/digitalriver.js/payment-methods/paypal.md#pay-in-4) to the [PayPal ](../payment-integrations-1/digitalriver.js/payment-methods/paypal.md)payment method.
...
We added a list of [error codes](../payment-integrations-1/digitalriver.js/reference/error-types-codes-and-objects.md#error-codes) for DigitalRiver.js.
...
We added information on the [tax identifier element](../payment-integrations-1/digitalriver.js/reference/tax-identifier-element.md) to [DigitalRiver.js](../payment-integrations-1/digitalriver.js/).

## 2020/10/1

We added support for Union Pay to [Credit Cards](../payment-integrations-1/digitalriver.js/payment-methods/credit-cards.md).

## 2020/9/30

* We added [PSD2 and SCA](../payment-integrations-1/psd2-and-sca/) integration support to [Payment integrations](../payment-integrations-1/). &#x20;
* We added information on migrating to [payment sessions](../payment-integrations-1/payment-sessions.md) to [Payment integrations](../payment-integrations-1/).&#x20;
...
We added support for the [Klarna ](../payment-integrations-1/digitalriver.js/payment-methods/klarna.md)payment method.

## 2020/9/18

We updated the [Drop-in](../payment-integrations-1/drop-in/) documentation.
...
* You can now use [**DigitalRiver.js**](../payment-integrations-1/digitalriver.js/) to retrieve an array of [available payment methods](https://docs.digitalriver.com/commerce-api/payment-integrations-1/digitalriver.js/reference/digitalriver-object#digitalriver-retrieveavailablepaymentmethods-filters).
* You can now use [**DigitalRiver.js**](../payment-integrations-1/digitalriver.js/) **** to trigger a [return event](https://docs.digitalriver.com/commerce-api/payment-integrations-1/digitalriver.js/reference/elements#return) when a customer presses the Return key while the input field has focus.
