...
2. The shopper [requests a refund](../../../admin-apis/returns-and-refunds-1/creating-a-satisfaction-refund.md). If you [configured notifications](broken-reference), the shopper receives a user refund confirmation.&#x20;
