...
Use the [Submit Cart](https://www.digitalriver.com/docs/commerce-shopper-api/#tag/Submit-Cart) resource to submit a cart. A cart cannot be submitted until the following items have been added or applied to the cart:
