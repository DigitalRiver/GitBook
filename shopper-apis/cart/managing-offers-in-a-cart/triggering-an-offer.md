---
description: Learn how to trigger an offer.
---

# Triggering an offer

## Trigging an offer by cart

Use the [`POST /line-items`](https://www.digitalriver.com/docs/commerce-shopper-api/#tag/API-Trigger-Offer/paths/\~1v1\~1shoppers\~1me\~1carts\~1active\~1line-items%20\(API%20Trigger%20Offer\)/post) API to trigger one or more order-level or product-level offers.
...
For more information see [API trigger offer source](../../../general-resources/shopper-apis-reference/carts.md#api-trigger-offer-source) and [API trigger offer query parameters](../../../general-resources/shopper-apis-reference/carts.md#api-trigger-offer-query-parameters).

## Triggering an offer by line item
