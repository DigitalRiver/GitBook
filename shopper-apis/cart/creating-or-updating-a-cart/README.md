...
All of the resources contained in the Cart can be leveraged to modify specific cart data elements. See [Update current cart query parameters](../../../general-resources/shopper-apis-reference/carts.md#update-current-cart-query-parameters) for more information.
...
* [Getting all applied offers](../managing-offers-in-a-cart/getting-all-applied-offers.md)
* [Reconciling conflicting offers](../managing-offers-in-a-cart/reconciling-conflicting-offers.md)
* [Removing eligible offers](../managing-offers-in-a-cart/removing-eligible-offers.md)
* [Removing an applied offer](../managing-offers-in-a-cart/removing-an-applied-offer.md)
...
* [Updating the shipping or billing address](managing-the-shipping-or-billing-address.md)
* [Providing subscription information](providing-subscription-information.md)
* [Adding required information for specific payment methods](managing-payment-methods/adding-required-information-for-specific-payment-methods.md)
