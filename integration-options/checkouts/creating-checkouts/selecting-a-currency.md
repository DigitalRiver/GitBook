...
For some payment methods, it's required that you set `currency` in the configuration object of [`createSource()`](../../../developer-resources/reference/digitalriver-object.md#creating-sources), while for others it's optional.&#x20;
