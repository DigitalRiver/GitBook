	...
	"OrderLevelElectronicFulfillmentRequest": {
		...
		"lineItemLevelRequest": {
			...
			"lineItemLevelPricing": {
				...
				"_xmlns:ns8": "http://integration.digitalriver.com/commonRequisition/1.0",
				"_xsi:type": "ns8:LineItemPriceInfo"
			},
			"replacementInfo": {
				"_xmlns:ns26": "http://integration.digitalriver.com/commonRequisition/1.0",
...
```javascript
{
	"ElectronicFulfillmentRevocationRequest": {
		...
		"replacementInfo": {
			"_xmlns:xsi": "http://www.w3.org/2001/XMLSchema-instance",
			"_xmlns:ns4": "http://integration.digitalriver.com/commonRequisition/1.0",
